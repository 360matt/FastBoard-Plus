...
public final class FastBoard {
    ...
    static {
        try {
            ...
            final Class<?> entityPlayerClass = FastReflection.nmsClass("EntityPlayer");
            final Class<?> playerConnectionClass = FastReflection.nmsClass("PlayerConnection");
     ...
     */
    public final void updateLine(final int line, final String text) {
     ...
     * @param line the line number
     */
    public final void removeLine(final int line) {
        checkLineNumber(line, false);
     ...
     * @throws IllegalStateException    if {@link #delete()} was call before
     */
    public final void updateLines(final String... lines) {
     ...
     * @throws IllegalStateException    if {@link #delete()} was call before
     */
    public final void updateLines(final Collection<String> lines) {
    ...
    private void checkLineNumber(final int line, final boolean checkMax) {
        if (line < 0) {
    ...
    private void sendObjectivePacket(final ObjectiveMode mode) throws ReflectiveOperationException {
    ...
    private void sendScorePacket(final int score, final ScoreboardAction action) throws ReflectiveOperationException {
    ...
    private void sendTeamPacket(final int score, final TeamMode mode) throws ReflectiveOperationException {
        ...
        if (mode == TeamMode.CREATE || mode == TeamMode.UPDATE) {
            ...
            if (line == null || line.isEmpty()) {
                ...
                final int index = line.charAt(15) == ChatColor.COLOR_CHAR ? 15 : 16;
    ...
    private String getColorCode(final int score) {
        return ChatColor.values()[score].toString();
    }

    private void sendPacket(final Object packet) throws ReflectiveOperationException {
        if (deleted) {
        ...
        if (player.isOnline()) {
            ...
            final Object playerConnection = PLAYER_CONNECTION.get(entityPlayer);
    ...
    private void setField(final Object object, final Class<?> fieldType, final Object value, final int count) throws ReflectiveOperationException {
        int i = 0;
    ...
    private void setComponentField(final Object object, final String value, final int count) throws ReflectiveOperationException {
        if (VERSION_TYPE != VersionType.V1_13) {
    ...
    enum VersionType {
        V1_7, V1_8, V1_13;
        public final boolean isHigherOrEqual() {
